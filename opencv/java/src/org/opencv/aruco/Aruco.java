...
public class Aruco {
    ...
    public static boolean testCharucoCornersCollinear(CharucoBoard _board, Mat _charucoIds) {
        return testCharucoCornersCollinear_0(_board.getNativeObjAddr(), _charucoIds.nativeObj);
    }
    ...
    // C++:  bool cv::aruco::testCharucoCornersCollinear(Ptr_CharucoBoard _board, Mat _charucoIds)
    private static native boolean testCharucoCornersCollinear_0(long _board_nativeObj, long _charucoIds_nativeObj);
